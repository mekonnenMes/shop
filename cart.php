                       ...
                       <div class="table-responsive"><!-- table-responsive Begin -->
                           ...
                           <table class="table"><!-- table Begin -->
                               ...
                               <tbody><!-- tbody Begin -->
                                   ...
                                   <tr><!-- tr Begin -->
                                       <td>
                                           <img class="img-responsive" src="admin_area/product_image/<?php echo $product_img1; ?>" alt="Product 3a">
                                       </td>
                                       <td>
               ...
               if(isset($_POST['apply_coupon'])){
                   ...
                   if($code == ""){
                        ...
                        if($check_coupons =="1")
                        {
                            ...
                            {
                                echo "<script>alert('Your coupon is expired')</script>";
                            }else{
                                ...
                                echo"<script>window.open('cart.php','_self')</script>";
                                    ...
                                    echo "<script>alert('Your coupon didn't match with the product')</script>";
                                }
                            }
                            }else{
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   ...
                   <?php
                    ...
                    while($row_products=mysqli_fetch_array($run_products)){
                        ...
                        $get_manu = "select * from manufacturer where manufacturer_id='$manu_id'";
