    ...
    <div class="panel-collapse collapse-data"><!-- panel-collapse collapse-data Begin -->
        ...
        <div class="panel-body"><!-- panel-body 1 Begin -->
            <div class="input-group"><!-- input-group Begin -->
                <input type="text" class="form-control" id="dev-table-filter" data-filters="#dev-manufacturers" data-action="filter" placeholder="Filter Manufacturer">
        ...
        <div class="panel-body scroll-menu"><!-- panel-body 2 Begin -->
            <ul class="nav nav-pills nav-stacked category-menu" id="dev-manufacturers"><!-- nav nav-pills nav-stacked category-menu Begin -->
                    ...
                    <li style='background:#dddddd' class='checkbox checkbox-primary'>
                        ...
                        <a>
                            ...
                            <label>
                                ...
                                echo " value='$manufacturer_id' type='checkbox' class='get_manufacturer' name='manufacturers'>
