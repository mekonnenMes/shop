        ...
        <div class="panel panel-default"><!-- panel panel-default begin-->
            ...
            <div class="panel-body"><!-- panel-body begin-->
                <form action="" class="form-horizontal" method="POST" enctype="multipart/form-data"><!-- form-horizontal begin-->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        <label class="control-label col-md-3"> Manufacturer Image</label>
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            <input name="manufacturer_image" type="file" class="form-control">
                        </div><!-- col-md-6 finish -->
                    </div><!-- form-group finish -->
...
if(isset($_POST['submit'])){
    ...
    move_uploaded_file($temp_name,"other_images/$manu_image");
        ...
        $insert_manu = "insert into manufacturer(manufacturer_title,manufacturer_top,manufacturer_image) values ('$manu_title','$manu_top','$manu_image')";
