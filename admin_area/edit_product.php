...
<?php 
    ...
    if(isset($_GET['edit_product'])){
        ...
        $p_features = $row_edit['features'];

        $p_video = $row_edit['video'];
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_image/<?php echo $p_image1; ?>" alt="<?php echo $p_image1; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_image/<?php echo $p_image2; ?>" alt="<?php echo $p_image2; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_image/<?php echo $p_image3; ?>" alt="<?php echo $p_image3; ?>">
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade in" id="videos"> <!-- Tab-pane Start -->
                                ...
                                <textarea rows="10" name="product_video" id="videos" class="form-control"><?php echo $p_video; ?></textarea>
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['file']['tmp_name'])){
        ...
        cat_id='$cat',manufacturer_id='$manufacturer_id',date=NOW(),
        ...
        product_keywords='$product_keywords',product_desc='$product_desc',
        product_sale='$product_sale',product_label='$product_label',
        features='$product_features',video='$product_video' where product_id='$p_id'";
        ...
        product_url='$product_url',product_price='$product_price',
        product_keywords='$product_keywords',product_desc='$product_desc',
        product_sale='$product_sale',product_label='$product_label',
        features='$product_features',video='$product_video' where product_id='$p_id'";
