...
<form action="" method="post" enctype="multipart/form-data"><!-- Form begin -->
    ...
    <div class="form-group"><!-- Form-group begin -->
        ...
        <img src="customer_images/<?php echo $customer_image; ?>" alt="Customer-Image" class="img-responsive" width="70" height="60">
    </div><!-- Form-group finish -->
...
<?php 
    if(isset($_POST['update'])){
        ...
        $update_customer = "update customer set customer_name='$c_name',customer_email='$c_email',customer_country='$c_country',
        customer_city='$c_city',customer_address='$c_address',customer_contact='$c_contact',customer_image='$c_image' where customer_id='$update_id'";
        $run_customer = mysqli_query($conn,$update_customer);
        if($run_customer){
            echo "<script>alert('Your account has been edited, to complete the process, please relog-in')</script>";
