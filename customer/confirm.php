                ...
                <div class="box"><!--box begin -->
                    ...
                    <form action="confirm.php?update_id=<?php echo $order_id; ?>" method="post" enctype="multipart/form-data"><!-- form Begin -->
                        ...
                        <div class="form-group"><!--form-group begin -->
                            ...
                            <select name="payment_mode" class="form-control"><!-- payment mode begin -->
                                <option> Select Payment Mode</option>
                                <option> Bank Code</option>
                                <option> Paypall</option>
                                <option> Wester Union</option>
                                <option> Account  </option>
                            </select><!-- payment mode finish -->
                        </div><!--form-group finish -->
                        <div class="form-group"><!--form-group begin -->
                        ...
                        <div class="form-group"><!--form-group begin -->
                            <label> Aktia /Nordea /Danske /OP /S-Bank </label>
                        ...
                        <div class="text-center"><!--text-center begin -->
                            <button class="btn btn-primary btn-lg" name="confirm_payment"><!-- button start -->
                    ...
                    if(isset($_POST['confirm_payment'])){
                        ...
                        if($run_pending_order){
                            echo "<script>alert('Thank you for purchasing, your order will be processed within 24 hrs')</script>";
